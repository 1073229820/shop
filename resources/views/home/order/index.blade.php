...
<div role="navigation" class="navbar header no-margin">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="{{url('index')}}" class="navbar-brand"><img src="/assets/home/img/logo_red.png" alt="Metronic Shop UI"></a><!-- LOGO -->
        ...
        <div class="row margin-bottom-40">
            ...
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    ...
                    <li class="list-group-item clearfix"><a href="/history/orders"><i class="fa fa-angle-right"></i> 历史订单</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12 clearfix">
                            <div class="table-wrapper-responsive">
                                <table summary="Shopping cart" class="table-bordered ">
                                    <tr>
                                        <th>订单号</th>
                                        ...
                                        <th class="checkout-total">合计</th>
                                        <th class="checkout-total">操作</th>

                                    </tr>
                                    @php($sum = 0)
                                    @foreach($orderList as $order)
                                        <tr>
                                            <td rowspan="{{count($order)}}">{{$order[0]['order_number']}}</td>
                                        @foreach($order as $val)
                                          @php($sum += $val['price']*$val['buynum'])
                                                ...
                                                <td class="shopping-cart-description">
                                                    <h3><a href="#">{{$val['goods_name']}}</a></h3>
                                                    <p><strong>Item 1</strong> - {{$val['logo']}} </p>
                                                    <em>查看详情</em>
                                                </td>
                                                ...
                                                <td class="shopping-cart-price">
                                                    <strong>￥<span>{{$val['price']}}</span></strong>
                                                </td>
                                                <td class="shopping-cart-total">
                                                    <strong>￥<span>{{sprintf("%.2f", $val['buynum']*$val['price'])}}</span></strong>
                                                </td>
                                                <td class="del-goods-col">
                                                    <a href="/admin/order">确认收货</a>
                                                </td>
                                            </tr>
