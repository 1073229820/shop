            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="post" action="/goods">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <!-- <input type="text" readonly class="image_path" name=art_thumb> -->
                ...
                <script type="text/javascript">
                    ...
                    $('div.type').on( 'change','select', function () {
                        ...
                        //这个AJAX获取选择商品类别的属性
                        $.get( '/data/attribute', {type_id: id}, function (data) {    
                            var str = '';
                            for (var i = 0; i<data.length; i++) {
                                str += `<div class="form-group">
                                            <label class="attr col-sm-3 control-label no-padding-right" for="form-field-1">`+data[i].attr_name+`</label>
                                            <div class="col-sm-9">`
                                var array = data[i].val.split(",");
                                                for(var j = 0; j<array.length; j++) {
                                                    str += `<input name="`+data[i].attr_name+`"  type="radio" value=`+array[j]+`>`+array[j];
                                                }
                                str += `    </div>                       
                                        </div>`
                            }
